...
const typeText = "Fast Consultant — We turn your business potential into success.";
(function typewriter() {
...
function initParticles() {
  const count = Math.max(50, Math.round((innerWidth * innerHeight) / 120000));
  particles = [];
...
(function () {
  emailjs.init("v6D4G99xKjSmb1IZD"); // your public key
})();
...
document.getElementById("contactForm")?.addEventListener("submit", function (e) {
  ...
  emailjs.sendForm("service_3k5ifyb", "template_q4cm598", this)
    .then(() => {
